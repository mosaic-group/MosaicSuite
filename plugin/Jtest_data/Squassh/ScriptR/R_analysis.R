...
##file names 
file_1="/tmp/test/stitch__NEW_ObjectData.csv"  #(objA channel)
file_2="/tmp/test/stitch__NEW_ObjectData.csv"  #(objB channel)
file_3="/tmp/test/stitch__NEW_ImageData.csv"  #(images mean results)
