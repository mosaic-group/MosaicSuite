...
##file names 
file_1="/private/tmp/test3//__ObjectsData_c1.csv/moImg_ObjectsData_c1.csv"  #(objA channel)
file_2="/private/tmp/test3//__ObjectsData_c2.csv/moImg_ObjectsData_c2.csv"  #(objB channel)
file_3="/private/tmp/test3//__ImagesData.csv/moImg_ImagesData.csv"  #(images mean results)
