...
public class JsonDataFileTest extends CommonBase {
    ...
    public void testGeneral() {
        ...
        final DataFile<TestConfig> df = new JsonDataFile<TestConfig>();
        assertTrue(df.SaveToFile(fileName, expectedData));

        // Tested method - read object from file
        final TestConfig result = new JsonDataFile<TestConfig>().LoadFromFile(fileName, TestConfig.class);
    ...
    public void testReadWrongObject() {
        ...
        final DataFile<String> df = new JsonDataFile<String>();
