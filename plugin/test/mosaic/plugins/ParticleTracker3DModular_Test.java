...
public class ParticleTracker3DModular_Test extends CommonBase {
    ...
    public void testLoadFromCsv()  {
        ...
        final String setupString         = "run";
        final String macroOptions        = "csv test=" + tmpPath + "test.csv link=2 displacement=10 dynamics=Brownian size=0 intensity=-1";
    ...
    public void testLoadFromTextFiles()  {
        ...
        final String setupString         = "run";
        final String macroOptions        = "multiple test=" + tmpPath + "/textFrames/frame_0 link=2 displacement=10 dynamics=Brownian";
        final String inputFile           = null;
        final String[] expectedImgFiles  = {};
        final String[] referenceImgFiles = {};
