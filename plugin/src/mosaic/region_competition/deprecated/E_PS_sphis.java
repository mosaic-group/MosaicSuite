...
public class E_PS_sphis extends ExternalEnergy
{
	...
	private SphereBitmapImageSource_sphis m_SphereMaskForLocalEnergy;
	...
	public void initSphere(int rad)
	{
		m_SphereMaskForLocalEnergy = new SphereBitmapImageSource_sphis(labelImage, rad, 2*rad+1);
	}
	...
	public EnergyResult CalculateEnergyDifference(Point contourPoint, ContourParticle contourParticle, int toLabel)
	{
    	...
    	int[] vRegion = m_SphereMaskForLocalEnergy.getRegionSize();
