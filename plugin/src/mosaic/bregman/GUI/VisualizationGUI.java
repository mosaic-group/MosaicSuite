...
class VisualizationGUI {
    ...
    public static int getParameters() {
        ...
        GenericGUI.addButton(p2, "Output options", new ActionListener() {
            @Override
        ...
        GenericGUI.addButton(p, "Set condition names and number of images per condition", new RScriptListener(gd, 0, 0));
        gd.addPanel(p);
