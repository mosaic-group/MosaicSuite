...
class ASplitBregmanSolverTwoRegions3DPSF extends ASplitBregmanSolver {
    ...
    public ASplitBregmanSolverTwoRegions3DPSF(Parameters aParameters, double[][][] image, double[][][] mask, MasksDisplay md, AnalysePatch ap, double aBetaMleOut, double aBetaMleIn, double aLreg, double aMinIntensity) {
        super(aParameters, image, mask, md, ap, aBetaMleOut, aBetaMleIn, aLreg, aMinIntensity);
