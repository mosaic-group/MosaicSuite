...
public class CMAMosaicObjectiveFunction extends AbstractObjectiveFunction {
	...
	public boolean isFeasible(double[] x) {
		...
		//	System.out.println(x[0]+" "+x[1]+" "+"min:"+minmaxmean[0]+"max:"+minmaxmean[1]);
			...
			if(x[0]>=0&&x[0]<=20 && x[1]>=minmaxmean[0]+1E-10 && x[1]<=minmaxmean[1] )
				return true;
			else
				return false;
		}
	...
	public double linearInterpolation(double yl, double xl, double yr, double xr, double x)
	{
