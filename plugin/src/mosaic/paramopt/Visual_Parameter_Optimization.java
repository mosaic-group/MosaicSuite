...
public class Visual_Parameter_Optimization implements PlugInFilter,
		IParameterRankingController, IParameterSelectionController,
		TableModelListener{

	public Visual_Parameter_Optimization() {}
	...
	private void createNextImages() {
		...
		for (int i = 0; i < currentPopulation.length; i++) {
			...
			images[i] = (new ij.plugin.Duplicator()).run(originalImp);//images[i] = originalImp.duplicate();
