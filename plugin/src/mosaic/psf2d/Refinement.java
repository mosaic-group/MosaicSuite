...
/**
 * TODO: should be replaced by the detection package!!!
...
public class Refinement{
	 ...
	 */
	public Refinement (ImageProcessor ip, int rad) {
		this.radius = rad;
		this.original_ip = ip;
		//this.particle = pat;
//		create Kernel and Mask for imageRestoration with the user defined radius 
	 ...
	 * @see SourcePosition
	 */
	public void refineParticlePosition (SourcePosition particle) {		
...
//	}
	...
	public SourcePosition getRefinedParticle(){
		return particle;
	}
}
